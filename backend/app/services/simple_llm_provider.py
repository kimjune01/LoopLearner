"""
Simple LLM Provider interface without Django dependencies
...
class SimpleLLMProvider(ABC):
    """Abstract interface for LLM providers without Django model dependencies"""
...
class SimpleOllamaProvider(SimpleLLMProvider):
    """Simple Ollama LLM Provider for development"""
