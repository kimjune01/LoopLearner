...
import OptimizationRunStats from './components/OptimizationRunStats'
    ...
    <Router>
      <div className="min-h-screen bg-gray-50">
        ...
        <Routes>
          ...
          <Route path="/prompt-labs/:promptLabId/optimization/runs/:runId/stats" element={<OptimizationRunStats />} />
          <Route path="/optimization-runs/:runId" element={<OptimizationRunDetail />} />
          <Route path="/optimization-runs/:runId/stats" element={<OptimizationRunStats />} />
